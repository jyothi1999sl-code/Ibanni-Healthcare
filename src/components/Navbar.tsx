    ...
    <nav className="glass-nav" style={{ position: 'fixed', width: '100%', top: 0, zIndex: 50 }}>
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.75rem 1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }} className="desktop-menu">
          <Link to="/" style={{ fontWeight: 700, color: 'var(--color-gray-800)', fontSize: '1rem' }}>Home</Link>
          <a href="/#about" style={{ fontWeight: 700, color: 'var(--color-gray-800)', fontSize: '1rem' }}>About</a>
          
          <div className="nav-dropdown">
            <Link to="/#equipment" style={{ fontWeight: 700, color: 'var(--color-gray-800)', display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '1rem' }}>
              Equipment
            </Link>
          ...
          <a href="/#contact" className="btn btn-3d" style={{ padding: '0.75rem 2rem', fontSize: '1rem', background: 'var(--color-primary)', color: 'white', borderRadius: '1.25rem' }}>
            Contact Sales
          </a>
        </div>
      </div>
